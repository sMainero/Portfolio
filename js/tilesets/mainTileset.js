...
export const MAIN_TILESET_SOLID_TILE_IDS = new Set([
  ...
  -2, 0, 2, 3, 6, 7, 8, 9, 14, 15, 16, 17, 18, 19, 22, 23, 24, 25, 30, 31, 32, 33, 34, 35, 36, 37,
...
export const loadMainTileset = async () => {
  await sharedLoader.loadImage(MAIN_TILESET_NAME, `${ASSETS_BASE}tilesets/mainTileset.png`);
