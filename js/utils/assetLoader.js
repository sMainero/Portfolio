...
let _imageTotal = 0;
let _imageLoaded = 0;
/** Lazily initialised on first loadImage() call — after loadingManager.init() has run. */
let _onImagesProgress = loadingManager.register('images');
...
export class AssetLoader {
  ...
  loadImage(key, src) {
    ...
    _imageTotal++;
    if (!_onImagesProgress) _onImagesProgress = loadingManager.register('images');
